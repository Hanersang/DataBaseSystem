...
%>
  ...
  &nbsp;编号：
  <input name="bianhao" type="text" id="bianhao" style='border:solid 1px #000000; color:#666666' size="15" />
  &nbsp;&nbsp;药品名称：
  <input name="mingcheng" type="text" id="mingcheng" style='border:solid 1px #000000; color:#666666' />&nbsp;&nbsp;药品类别：
  <input name="leibie" type="text" id="leibie" style='border:solid 1px #000000; color:#666666' />&nbsp;&nbsp;客户姓名：<input name="kehuxingming" type="text" id="kehuxingming" style='border:solid 1px #000000; color:#666666' size="12" />
  &nbsp;&nbsp;经手人：
  <input name="jingshouren" type="text" id="jingshouren" style='border:solid 1px #000000; color:#666666' size="12" />
...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="00FFFF" style="border-collapse:collapse">  
  ...
  int curpage=1;//当前页
				...
				String fysql="select count(id) as ss from xiaoshoutuihuo";
...
if(((curpage-1)*page_record)==0 || curpage==0)
   {
  sql="select  * from xiaoshoutuihuo where 1=1 ";
   }
   else
   {
   String tempsql="select  id from xiaoshoutuihuo order by id desc limit 0,"+(curpage-1)*page_record+"";
  ...
  sql="select  * from xiaoshoutuihuo where id not in ("+tempidstring+")  ";
  }
...
<p align="center">&nbsp;共<%=zgs%>条记录&nbsp;&nbsp;<%=page_record %>条/页　<a href="xiaoshoutuihuo_list.jsp?page=1">首页</a>　<a href="xiaoshoutuihuo_list.jsp?page=<%= curpage-1%>">上一页</a>　<A href="xiaoshoutuihuo_list.jsp?page=<%= curpage+1%>">下一页</A>　<a href="xiaoshoutuihuo_list.jsp?page=<%=zys %>">尾页</A>　当前第<FONT color=red><%=curpage %></FONT>页/共<FONT color=red><%=zys %></FONT>页</p>
  </body>
</html>
