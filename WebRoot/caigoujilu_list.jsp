...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="00FFFF" style="border-collapse:collapse">  
  <tr>
    ...
    <td bgcolor='#CCFFFF'>库存</td><td bgcolor='#CCFFFF'>进货数量</td><td bgcolor='#CCFFFF'>进货价</td><td bgcolor='#CCFFFF'>供应商</td>
...
%>
  <tr>
    ...
    <td><%=bianhao %></td><td><%=mingcheng %></td><td><%=leibie %></td><td><%=kucun %></td><td><%=caigoushuliang %></td><td><%=caigoujia %></td><td><%=gongyingshang %></td>
    <td><%=beizhu %></td>
    <td><%=jingshouren %></td>
...
<p align="center">&nbsp;共<%=zgs%>条记录&nbsp;&nbsp;<%=page_record %>条/页　<a href="caigoujilu_list.jsp?page=1">首页</a>　<a href="caigoujilu_list.jsp?page=<%= curpage-1%>">上一页</a>　<A href="caigoujilu_list.jsp?page=<%= curpage+1%>">下一页</A>　<a href="caigoujilu_list.jsp?page=<%=zys %>">尾页</A>　当前第<FONT color=red><%=curpage %></FONT>页/共<FONT color=red><%=zys %></FONT>页</p>
  </body>
</html>
