...
function b_writeStyle() {
  ...
  document.write('background-image: url(images/main/top/menu/across.gif);background-repeat: no-repeat;');
  ...
  if (bt.ns4) {                 //draw OutlookBar for ns4
    ...
    for (i=0;i<this.panels.length;i++) {
      document.write('<Layer name='+this.name+'_panel'+i+' width='+this.width);
       ...
       document.write('width=16 height=16 src=images/main/top/menu/arrowup.gif border=0>');
       ...
       document.write('src=images/main/top/menu/arrowdown.gif border=0></A></LAYER>');
    ...
    //document.write('; height:'+this.height+'; background:images/main/top/menu/across.gif')
    ...
    for (i=0;i<this.panels.length;i++) {
      ...
      document.write('onmouseOver="'+this.panels[i].v+'.clear();">');
      document.write('<img width=16 height=16 src=images/main/top/menu/arrowup.gif border=0 id=uup>');
      ...
      document.write('onmouseOver="'+this.panels[i].v+'.clear();">');
      document.write('<img width=16 height=16 src=images/main/top/menu/arrowdown.gif border=0 id=ddown>');
      document.write('</A></DIV>');
