...
String sql="update kehuxinxi set bianhao='"+bianhao+"',xingming='"+xingming+"',shenfenzheng='"+shenfenzheng+"',dianhua='"+dianhua+"',QQ='"+QQ+"',xingbie='"+xingbie+"',leixing='"+leixing+"',dizhi='"+dizhi+"',beizhu='"+beizhu+"' where id= "+id;
connDbBean.executeUpdate(sql);
out.print("<script>alert('ÐÞ¸Ä³É¹¦!!');location.href='kehuxinxi_list.jsp';</script>");
%>
  </body>
</html>
