...
<html>
  <head>
    ...
    <title>客户信息</title><script language="javascript" src="js/Calendar.js"></script>
...
function check()
{
  ...
  String id=request.getParameter("id");
   %>
  <form name="form1" id="form1" method="post" action="kehuxinxi_updt_post.jsp?id=<%=id %>">
  修改客户信息:
  <br><br>
  <%
