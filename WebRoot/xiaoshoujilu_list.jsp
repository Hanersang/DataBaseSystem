...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="00FFFF" style="border-collapse:collapse">  
  <tr>
    ...
    <td bgcolor='#CCFFFF'>价格</td><td bgcolor='#CCFFFF'>库存</td><td bgcolor='#CCFFFF'>客户姓名</td><td bgcolor='#CCFFFF'>出货数量</td>
...
<p align="center">&nbsp;共<%=zgs%>条记录&nbsp;&nbsp;<%=page_record %>条/页　<a href="xiaoshoujilu_list.jsp?page=1">首页</a>　<a href="xiaoshoujilu_list.jsp?page=<%= curpage-1%>">上一页</a>　<A href="xiaoshoujilu_list.jsp?page=<%= curpage+1%>">下一页</A>　<a href="xiaoshoujilu_list.jsp?page=<%=zys %>">尾页</A>　当前第<FONT color=red><%=curpage %></FONT>页/共<FONT color=red><%=zys %></FONT>页</p>
  </body>
</html>
