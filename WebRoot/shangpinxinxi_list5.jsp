...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="00FFFF" style="border-collapse:collapse">  
  <tr>
    ...
    <td bgcolor='#CCFFFF'>价格</td><td bgcolor='#CCFFFF' width='90' align='center'>图片</td>
    <td width="138" align="center" bgcolor="CCFFFF">预计下月出货量</td>
  </tr>
  <%
  int curpage=1;//当前页
...
%>
  <tr>
    ...
    <td><%=bianhao %></td><td><%=mingcheng %></td><td><%=leibie %></td><td><%=jiage %></td><td width='90'><a href='<%=tupian %>' target='_blank'><img src='<%=tupian %>' width=88 height=99 border=0 /></a></td><td width="138" align="center"><%
	 sql2="select xiaoshoushuliang from xiaoshoujilu where bianhao='"+bianhao+"'";
     RS_result2=connDbBean.executeQuery(sql2);
	float zs=0;
	float kk=0;
	float pj=0;
	 while(RS_result2.next()){
	 kk=kk+1;
		zs=zs+Float.valueOf(RS_result2.getString("xiaoshoushuliang")).floatValue();
}
if(zs==0)
{
pj=0;
...
<p align="center">&nbsp;共<%=zgs%>条记录&nbsp;&nbsp;<%=page_record %>条/页　<a href="shangpinxinxi_list5.jsp?page=1">首页</a>　<a href="shangpinxinxi_list5.jsp?page=<%= curpage-1%>">上一页</a>　<A href="shangpinxinxi_list5.jsp?page=<%= curpage+1%>">下一页</A>　<a href="shangpinxinxi_list5.jsp?page=<%=zys %>">尾页</A>　当前第<FONT color=red><%=curpage %></FONT>页/共<FONT color=red><%=zys %></FONT>页</p>
  </body>
</html>
